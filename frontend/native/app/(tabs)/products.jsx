  ...
  const featuredProducts = [
    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      <View style={{ paddingHorizontal: theme.spacing.md, paddingTop: theme.spacing.lg, backgroundColor: theme.colors.background }}>
        ...
        >
          <TouchableOpacity style={{ backgroundColor: theme.colors.primary, paddingHorizontal: 16, height: FILTER_BUTTON_HEIGHT, justifyContent: 'center', borderRadius: 999, marginRight: 8 }}>
            <Text style={{ color: '#fff', fontWeight: 'bold' }}>All</Text>
          </TouchableOpacity>
          {categories.map(category => (
            <TouchableOpacity key={category.id} style={{ backgroundColor: '#E5E7EB', paddingHorizontal: 16, height: FILTER_BUTTON_HEIGHT, justifyContent: 'center', borderRadius: 999, marginRight: 8 }}>
